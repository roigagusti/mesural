...
$fecha = date("F jS Y", strtotime($register['create_date']));

$subject = "Welcome to Mesural";
$body = '<!DOCTYPE html>
<html lang="en">
<head>
              ...
              <td>
                <table class="header-content" width="520" cellspacing="0" cellpadding="0" border="0" align="center">
                  <tbody>
                    ...
                    <tr>
                      <td align="center">
                      	<img src="https://app.mesural.com/img/mail/icon-activate.png" height="100" border="0">
                      </td>
                    </tr>
                    <tr>
                      <td height="40"></td>
      ...
      <td>
        <table class="content-content" width="400" cellspacing="0" cellpadding="0" border="0" align="center">
          <tbody>
            <tr>
              <td align="center">
              	Welcome, you are ready to setup your Mesural account. Please, click the button below to confirm.
              </td>
            </tr>
            <tr>
              <td height="50"></td>
                  ...
                  <tbody>
                    <tr>
                      <td class="cta-activate" valign="middle" align="center" style="height:50px;">
                        <a href="https://app.mesural.com/conexiones/validar_usuario.php?token='.$token.'">Activate your account</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
