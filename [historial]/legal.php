...
if ($_SERVER['SERVER_NAME'] != "www.mesural.com") {
    $page = explode("/",$_SERVER['REQUEST_URI'])['2'];
    $url = "https://www.mesural.com/".$page;
    header("Location: $url");
    exit;
}
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12 text-justify">							
							...
							<p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Mesural (<strong>"Company"</strong>, <strong>“we”</strong>, <strong>“us”</strong>, or <strong>“our”</strong>), concerning your access to and use of the <a href="//www.mesural.com">www.mesural.com</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
							...
							4. Make improper use of our support services or submit false reports of abuse or misconduct.<br>
							5. Use the Site in a manner inconsistent with any applicable laws or regulations.<br>
							6. Use the Site to advertise or offer to sell goods and services.<br>
							7. Engage in unauthorized framing of or linking to the Site.<br>
							...
							13. Interfere with, disrupt, or create an undue burden on the Site or the networks or services connected to the Site.<br>
							...
							15. Copy or adapt the Site’s software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.<br>
							16. Decipher, decompile, disassemble, or reverse engineer any of the software comprising or in any way making up a part of the Site.<br>
							...
							19. Make any unauthorized use of the Site, including collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending unsolicited email, or creating user accounts by automated means or under false pretenses.<br>
							20. Use the Site as part of any effort to compete with us or otherwise use the Site and/or the Content for any revenue-generating endeavor or commercial enterprise.</p>
							...
							<p>These conditions are governed by and interpreted following the laws of Spain, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. Mesural and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Barcelona, which means that you may make a claim to defend your consumer protection rights in regards to these Conditions of Use in Spain, or in the EU country in which you reside.</p>
							
							<strong>DISPUTE RESOLUTION</strong>
							<p>The European Commission provides an online dispute resolution platform, which you can access here: <a href="//ec.europa.eu/consumers/odr" target="_blank">https://ec.europa.eu/consumers/odr</a>. If you would like to bring this subject to our attention, please contact us.</p>
							...
							<p><strong>Mesural</strong><br>
							Edifici Mediatic, Roc boronat 117, 2nd floor<br>
							Barcelona, Barcelona 08018<br>
							Spain<br>
							info@mesural.com</p>

							<p><br><br>This document was last updated on March 06, 2020</p>
						</div>
					</div>
				</div>
			</section>
