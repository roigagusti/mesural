<div class="lateral col-lg-2 col-xs-3">
  ...
  <ul class="navegador">
    <?php if($_SERVER['REQUEST_URI'] != "/import.php"){if($_SERVER['REQUEST_URI'] != "/settings.php"){echo '<li class="active">';}else{echo '<li>';}}else{echo '<li>';} ?>
      <a href="index.php">
        <span class="nav-title">Control center</span>
      </a>
    </li>
    <?php if($_SERVER['REQUEST_URI'] == "/import.php"){echo '<li class="active">';}else{echo '<li>';} ?>
      <a href="import.php">
        <span class="nav-title">Data import</span>
      </a>
    </li>
    <?php if($_SERVER['REQUEST_URI'] == "/settings.php"){echo '<li class="active">';}else{echo '<li>';} ?>
      <a href="settings.php">
...
<div class="lateral-footer-mobile">
  <ul class="navegador-mobile">
    <?php if($_SERVER['REQUEST_URI'] != "/import.php"){if($_SERVER['REQUEST_URI'] != "/settings.php"){echo '<li class="col-xs-4 active">';}else{echo '<li class="col-xs-4">';}}else{echo '<li class="col-xs-4">';} ?>
      <a href="index.php">
