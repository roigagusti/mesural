  ...
  <div class="main-content">
    <div class="page-content">
      <div class="container-fluid">
        ...
        <?php 
        $device = $_GET['device'];
        $deviceId = $database->get("capsuleInfo","id",["deviceKey"=>$device]);
        ...
        $capsula = $database->get('capsuleProperty', [
            ...
            'deviceUse',
            'createDate',
          ],["AND"=>["deviceID"=>$deviceId, "userID"=>$id]]
        );
        $deviceKey = $database->get('capsuleInfo', 'deviceKey', ["id"=>$deviceId]);
        $frequency = $database->get('capsuleInfo', 'frequency', ["id"=>$deviceId]);
        ?>
          ...
          <div class="col-xl-8">
              <div class="card mb-0">
                  ...
                  <div class="tab-content p-4">
                    <?php
                    if($_GET['omega']=="1"){$om=1;}else{$om=0;}
                      $datas = $database->select("capsuleValues_lep", [
                          ...
                          "weatherHumidity",
                          "weatherMain"
                          ],["AND"=>["deviceID"=>$deviceId,"type"=>$om],"ORDER"=>["createDate"=>"DESC"]]);
                      echo "Entradas: ".count($datas);
                    ?>
