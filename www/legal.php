				...
				<div class="container legal">
					...
					<div class="row">
						<div class="col-md-12 text-justify">							
							...
							<p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Mesural (<strong>"Company"</strong>, <strong>“we”</strong>, <strong>“us”</strong>, or <strong>“our”</strong>), concerning your access to and use of the <a href="https://www.mesural.com" hreflang="<?php echo $text['Lang']; ?>">www.mesural.com</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
							...
							<p>The European Commission provides an online dispute resolution platform, which you can access here: <a href="https//ec.europa.eu/consumers/odr" hreflang="en" target="_blank">https://ec.europa.eu/consumers/odr</a>. If you would like to bring this subject to our attention, please contact us.</p>
